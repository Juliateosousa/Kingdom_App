  ...
  Future<void> loginUser() async {
    ...
    try {
      ...
      Widget nextPage;
            ...
            switch (role) {
        // 🔑 Super admin → tela com 3 botões (Admin / KFL / KBR)
        case 'superadmin':
          nextPage = const SuperAdminHomePage();
          break;

        // Admin (vale pra todas as unidades)
        case 'adminkbr':
        case 'adminkfl':
        case 'admin':
        ...
        // Se não tiver role, cai num "home" genérico
        default:
