...
class KitchenPage extends StatelessWidget {
  ...
  final bool showBackArrow; // 👈 seta só quando vier do Super Admin
  ...
  Widget build(BuildContext context) {
    // IDs dos documentos no Firestore (cozinha)
    ...
    // 👉 FINALIZAR: envia TODAS as listas da COZINHA para o admin
    // (NÃO zera values, urgente, nem X)
    Future<void> finalizeAllLists() async {
      ...
      try {
        for (int i = 0; i < listIds.length; i++) {
          ...
          // apaga doc antigo dessa lista/location/category
          ...
          // cria novo doc em finishedLists
    ...
    // 👉 LIMPAR LISTA: zera TODOS os values, o urgente e o X da unidade atual
    ...
    // 👉 PDF da Kitchen (separado da tela, igual Hall)
    ...
    return Scaffold(
      appBar: AppBar(
        // seta de voltar só quando vier do Super Admin
        automaticallyImplyLeading: showBackArrow,

        // quando NÃO vier do admin: mostra PDF no lugar da seta (leading)
        ...
        actions: [
          // 👉 BOTÃO LIMPAR LISTA (VERMELHO) – agora com pop-up de confirmação
          TextButton(
            onPressed: () async {
          ...
          // 👉 SE vier do Super Admin: PDF fica no lugar do logout (na direita)
          if (showBackArrow)
            IconButton(
              icon: const Icon(Icons.picture_as_pdf),
              onPressed: shareKitchenPdf,
            )
          // 👉 SE for Kitchen normal (sem admin): mostra logout na direita
          else
            IconButton(
      ...
      body: Column(
        children: [
          // 🔽 LISTA TODA (todas as seções da cozinha)
          Expanded(
                ...
                return Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Cabeçalho da seção: nome da lista
                        Text(
                          listName,
                              ...
                              itemBuilder: (context, i) {
                                ...
                                return Dismissible(
                                  ...
                                  confirmDismiss:
                                    ...
                                    // 👉 Swipe para a direita: alterna o isZeroX
                                    final bool current =
                                        (data['isZeroX'] ?? false) as bool;
                                    await item.reference.update({
                                      'isZeroX': !current,
                                    });
                                    // não remover o item da lista
                                    return false;
                                  },
                                  child: Card(
                                    color: cardColor,
                                    ...
                                    child: ListTile(
                                      ...
                                      trailing: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            ...
                                            onPressed: () {
                                              // aqui não mexe no X, só no valor
                                              if (value > 0) {
                                      ...
                                      // clique longo ainda alterna o urgente (vermelho)
                                      onLongPress: () {
                                        item.reference.update({
                                          'isUrgent': !isUrgent,
                                        });
