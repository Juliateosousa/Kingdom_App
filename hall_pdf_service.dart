...
class HallPdfService {
  static Future<Uint8List> generateHallPdf({
    required String location,
    required String shortLoc,
    ...
    for (int i = 0; i < listIds.length; i++) {
      ...
      for (final doc in snap.docs) {
        ...
        // - se urgente => linha vermelha
        // (prioridade visual: X > urgente)
        PdfColor? bgColor;
        ...
        rows.add(
          pw.TableRow(
            ...
            children: [
              ...
              _cell(minNum.toString(), rowTextStyle, alignCenter: true),
            ],
          ),
        );
      }
      ...
      content.add(
        pw.Table(
          ...
          columnWidths: {
            ...
            1: pw.FlexColumnWidth(1), // Current Stock
            2: pw.FlexColumnWidth(1), // Minimum Stock
          },
          children: rows,
        ),
      );
